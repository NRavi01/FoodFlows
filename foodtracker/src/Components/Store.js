        ...
        return (
          ...
          <form onSubmit = {this._enterData}>
              ...
              <div className="three columns header-col">
                ...
                <div className="nine columns main-col">
                    <div className="row item">
                      <input type="text" defaultValue="" size="25" id="Store Name" name="Store Name" value={this.state.value} onChange={this.storeName}/>
                    </div>
                </div>
            </div>
            ...
            <div className="row work">
              ...
              <div className="three columns header-col">
                  <h1><span>Street Name</span></h1>
              </div>

              <div className="nine columns main-col">
                <div className="row item">
                  <input value={this.state.value} onChange={this.streetName} type="text" defaultValue="" size="25" id="Street Name" name="Street Name" o/>
                </div>
              </div>
            </div>
            ...
            <div className="row work">
              ...
              <div className="three columns header-col">
                  <h1><span>City Name</span></h1>
              </div>

              <div className="nine columns main-col">
                <div className="row item">
                  <input value={this.state.value} onChange={this.cityName} type="text" defaultValue="" size="25" id="City Name" name="City Name" o/>
                </div>
              </div>
            </div>
            ...
            <div className="row skill">
              ...
              <div className="nine columns main-col">
                <div className="row item">
                  <input align="center" type="submit" value="Find Store" />                </div>
              </div>
            </div>
          </form>
      </section>
